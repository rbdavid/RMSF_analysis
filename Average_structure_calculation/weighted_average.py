...
necessary_parameters = ['distance_functions_file','pdb','avg_pdb_loc','start','end','step','alignment_selection','analysis_selection','average_structure_file_name']
all_parameters = ['distance_functions_file','pdb','traj_loc','start','end','alignment_selection','analysis_selection','average_structure_file_name','summary_boolean','summary_file_name']
...
def main():
        ...
        pdb_list = [parameters['avg_pdb_loc']%(i,i+parameters['step']-1) for i in range(parameters['start'],parameters['end']+1,parameters['step'])]

        average_structure_calc(parameters['pdb'],parameters['alignment_selection'],parameters['analysis_selection'],pdb_list,parameters['average_structure_file_name'])
